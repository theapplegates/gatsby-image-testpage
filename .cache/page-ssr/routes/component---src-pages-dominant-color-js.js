...
function merge(registered, css, className) {
  ...
  var rawClassName = (0,emotion_utils_esm/* getRegisteredStyles */.f)(registered, registeredStyles, className);
...
var createEmotion = function createEmotion(options) {
  ...
  var css = function css() {
    ...
    (0,emotion_utils_esm/* insertStyles */.M)(cache, serialized, false);
  ...
  return {
    ...
    sheet: cache.sheet,
    cache: cache,
    getRegisteredStyles: emotion_utils_esm/* getRegisteredStyles.bind */.f.bind(null, cache.registered),
...
// EXTERNAL MODULE: external "/Users/thor3/Documents/using-gatsby-image/node_modules/react/index.js"
var index_js_ = __webpack_require__(8609);
...
/* harmony export */   "zH": () => (/* binding */ j)
/* harmony export */ });
/* unused harmony exports MainImage, Placeholder, generateImageData, getImageData, getLowResolutionImageURL, getSrc, getSrcSet */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8609);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8609);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9991);
/* harmony import */ var _utils_presets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2374);
/* harmony import */ var _utils_presets__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_utils_presets__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_typography__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5713);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6657);
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Buffer=(__webpack_require__(8764)/* .Buffer */ .lW);const OuterContainer=/*#__PURE__*/(0,_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(`div`, true?{target:"ele3b5h4"}:0)("background:#fff;",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.tablet,"{margin:0;margin-left:calc(-",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.offset," - ",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.tablet,");padding:6.25rem;padding-right:0;}",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.desktop,"{margin-left:calc(-",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.offset," - ",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.desktop,");}",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.xl,"{margin-right:-",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.desktop,";}",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.xxl,"{margin-left:calc(-",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.offsetXxl," - ",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.desktop,");}"+( true?"":0));const Grid=/*#__PURE__*/(0,_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(`div`, true?{target:"ele3b5h3"}:0)("column-count:1;column-gap:",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter["default"],";",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.mobile,"{column-count:2;}",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.tablet,"{column-count:3;}",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.xl,"{column-gap:",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.tablet,";}"+( true?"":0));const GridItem=/*#__PURE__*/(0,_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(`div`, true?{target:"ele3b5h2"}:0)("break-inside:avoid;position:relative;margin-bottom:",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter["default"],";",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.mq.xl,"{margin-bottom:",_utils_presets__WEBPACK_IMPORTED_MODULE_2__.gutter.tablet,";}"+( true?"":0));const GridItemImage=/*#__PURE__*/(0,_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__/* .GatsbyImage */ .HN, true?{target:"ele3b5h1"}:0)( true?{name:"a4dflq",styles:"&:hover{[data-placeholder-image]{opacity:1!important;transition:none!important;}[data-main-image]{opacity:0!important;transition:none!important;}}"}:0);const Badge=/*#__PURE__*/(0,_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(`span`, true?{target:"ele3b5h0"}:0)("background:#fff;bottom:0.625rem;border-radius:0.125rem;color:",_utils_typography__WEBPACK_IMPORTED_MODULE_3__.options.bodyColor,";font-family:",_utils_typography__WEBPACK_IMPORTED_MODULE_3__.options.monospaceFontFamily.join(`,`),";font-size:",(0,_utils_typography__WEBPACK_IMPORTED_MODULE_3__.scale)(-2).fontSize,";line-height:1;padding:0.25rem;pointer-events:none;position:absolute;opacity:0.5;right:0.625rem;"+( true?"":0));const ImageGallery=edges=>(0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(OuterContainer,null,(0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(Grid,null,edges.images.map(image=>{var _img$placeholder$fall,_img$placeholder;const img=(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_4__/* .getImage */ .gJ)(image.node.localFile);console.log({image});const fallbackString=(_img$placeholder$fall=img===null||img===void 0?void 0:(_img$placeholder=img.placeholder)===null||_img$placeholder===void 0?void 0:_img$placeholder.fallback)!==null&&_img$placeholder$fall!==void 0?_img$placeholder$fall:img===null||img===void 0?void 0:img.backgroundColor;const byteLength=Buffer.byteLength(fallbackString,`utf8`);return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(GridItem,{key:fallbackString},(0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(GridItemImage,{image:img,alt:`“${image.node.title}” by ${image.node.credit} (via unsplash.com)`}),byteLength>1000?(0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(Badge,null,"Placeholder ",(byteLength/1000).toFixed(1),"kB"):(0,_emotion_react__WEBPACK_IMPORTED_MODULE_5__/* .jsx */ .tZ)(Badge,null,"Placeholder ",byteLength.toFixed(1),"B"));})));/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ImageGallery);
...
var gatsby_image_module = __webpack_require__(9991);
...
function MdLink (props) {
  return (0,esm/* GenIcon */.w_)({"tag":"svg","attr":{"viewBox":"0 0 24 24"},"child":[{"tag":"path","attr":{"d":"M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"}}]})(props);
};
...
var typography = __webpack_require__(5713);
// EXTERNAL MODULE: ./src/utils/presets.js
var presets = __webpack_require__(2374);
;// CONCATENATED MODULE: ./src/components/navigation.js
const linkStyle=/*#__PURE__*/(0,emotion_react_esm/* css */.iv)("font-family:",typography.options.headerFontFamily.join(`,`),";font-weight:700;letter-spacing:0.005em;position:relative;transition:",presets.animation.speedDefault," ",presets.animation.curveExpo,";white-space:nowrap;@media (-webkit-min-device-pixel-ratio: 0){background-image:linear-gradient(\n      45deg,\n      #eb4d9c,\n      #d33024,\n      #e48233,\n      #f4e24d,\n      #b4dc48,\n      #54b2ea,\n      ",presets.colors.gatsby," 50%\n    );background-size:200% 200%;color:rgba(102, 51, 153, 1);-webkit-background-clip:text;&:hover{background-position:0 0;color:rgba(102, 51, 153, 0);}}"+( true?"":0), true?"":0);const assignActiveStyles=({isPartiallyCurrent})=>isPartiallyCurrent?{className:/*#__PURE__*/(0,emotion_react_esm/* css */.iv)(linkStyle,";&&{color:rgba(0, 0, 0, 1);&:before{background-color:#000;bottom:-0.0625em;content:\"\";height:0.125em;left:0;position:absolute;right:0;width:0.65em;}&:hover{background-position:100% 0;color:initial;}}"+( true?"":0), true?"":0)}:{className:/*#__PURE__*/(0,emotion_react_esm/* css */.iv)(linkStyle,";"+( true?"":0), true?"":0)};const SiteTitle=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`h1`, true?{target:"e1b8h6wj4"}:0)("margin:0;position:fixed;left:-2.75rem;top:8rem;font-size:",(0,typography.scale)(1).fontSize,";line-height:1;transform:rotate(90deg);",presets.mq.tablet,"{z-index:",presets.elevation.overlay+1,";}"+( true?"":0));const Nav=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`nav`, true?{target:"e1b8h6wj3"}:0)("background:#fff;margin-left:-",presets.gutter["default"],";margin-right:-",presets.gutter["default"],";overflow-x:auto;padding-bottom:",presets.gutter["default"],";padding-left:",presets.gutter["default"],";padding-top:",presets.gutter["default"],";position:relative;z-index:",presets.elevation.raised,";",presets.mq.tablet,"{margin-left:0;margin-right:0;overflow-x:initial;padding-left:0;padding-top:0;}"+( true?"":0));const NavList=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`ul`, true?{target:"e1b8h6wj2"}:0)("margin:0;list-style:none;white-space:nowrap;",presets.mq.tablet,"{max-width:30rem;margin-left:-7.5rem;white-space:initial;}"+( true?"":0));const NavListItem=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`li`, true?{target:"e1b8h6wj1"}:0)("display:inline;",presets.mq.phablet,"{font-size:",(0,typography.scale)(1).fontSize,";}",presets.mq.tablet,"{font-size:",(0,typography.scale)(2).fontSize,";}",presets.mq.xl,"{font-size:",(0,typography.scale)(3).fontSize,";}"+( true?"":0));const NavItem=({title,to})=>(0,emotion_react_esm/* jsx */.tZ)(NavListItem,{css:/*#__PURE__*/(0,emotion_react_esm/* css */.iv)("&:after{color:",presets.colors.gatsby,";content:\" \u2571 \";font-weight:300;opacity:0.5;font-size:50%;position:relative;bottom:0.25rem;padding:0 ",(0,typography.rhythm)(typography.options.blockMarginBottom/4),";}&:last-child:after{display:none;}"+( true?"":0), true?"":0)},(0,emotion_react_esm/* jsx */.tZ)(gatsby_browser_entry.Link,{to:to,getProps:assignActiveStyles},title));const ExternalLinkIcon=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(MdLink, true?{target:"e1b8h6wj0"}:0)("background-image:none;bottom:-0.2em;color:",presets.colors.gatsby,";font-size:75%;position:relative;vertical-align:baseline;",presets.mq.tablet,"{bottom:-0.15em;font-size:60%;}"+( true?"":0));const Navigation=()=>(0,emotion_react_esm/* jsx */.tZ)("header",null,(0,emotion_react_esm/* jsx */.tZ)(SiteTitle,null,(0,emotion_react_esm/* jsx */.tZ)(gatsby_browser_entry.Link,{to:"/",css:`
          ${linkStyle};
        `},"Using Gatsby Image")),(0,emotion_react_esm/* jsx */.tZ)(Nav,{"aria-label":"Primary Navigation"},(0,emotion_react_esm/* jsx */.tZ)(NavList,null,(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/dominant-color/",title:"Dominant Color"}),(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/blur-up/",title:"Blur Up"}),(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/traced-svg/",title:"Traced SVG"}),(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/prefer-webp/",title:"WebP"}),(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/static-images/",title:"StaticImage"}),(0,emotion_react_esm/* jsx */.tZ)(NavItem,{to:"/art-direction/",title:"Art Direction"}),(0,emotion_react_esm/* jsx */.tZ)(NavListItem,null,(0,emotion_react_esm/* jsx */.tZ)("a",{href:"https://www.gatsbyjs.com/plugins/gatsby-plugin-image/",css:/*#__PURE__*/(0,emotion_react_esm/* css */.iv)(linkStyle,";"+( true?"":0), true?"":0)},"Docs",` `,(0,emotion_react_esm/* jsx */.tZ)(ExternalLinkIcon,null))))));/* harmony default export */ const navigation = (Navigation);
;// CONCATENATED MODULE: ./src/images/monogram.svg
/* harmony default export */ const monogram = ("data:image/svg+xml;base64,");
;// CONCATENATED MODULE: ./src/components/layout.js
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}const Container=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`div`, true?{target:"e8o33en4"}:0)("background:#fff;margin-top:calc(67vh - ",presets.gutter["default"],");padding:",presets.gutter["default"],";position:relative;",presets.mq.tablet,"{background:#fff;margin-left:",presets.offset,";margin-top:0;max-width:37.5rem;padding:",presets.gutter.tablet,";position:relative;}",presets.mq.desktop,"{padding:",presets.gutter.desktop,";padding-top:",presets.gutter.tablet,";}",presets.mq.xxl,"{margin-left:",presets.offsetXxl,";}"+( true?"":0));const Image=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(gatsby_image_module/* GatsbyImage */.HN, true?{target:"e8o33en3"}:0)("bottom:33vh;left:",presets.gutter["default"],";right:",presets.gutter["default"],";top:",presets.gutter["default"],";",presets.mq.tablet,"{bottom:0;left:0;right:auto;top:0;width:",presets.offset,";}",presets.mq.xxl,"{width:",presets.offsetXxl,";}"+( true?"":0));const Main=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`main`, true?{target:"e8o33en2"}:0)("background:#fff;padding-top:",presets.gutter["default"],";position:relative;z-index:",presets.elevation.overlay,";"+( true?"":0));const LogoLink=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`a`, true?{target:"e8o33en1"}:0)("height:",(0,typography.rhythm)(0.875),";line-height:1;position:fixed;top:",presets.gutter.tablet,";right:",presets.gutter.tablet,";width:",(0,typography.rhythm)(0.875),";&&{background:transparent;}",presets.mq.tablet,"{bottom:",presets.gutter.tablet,";left:",presets.gutter.tablet,";top:auto;z-index:",presets.elevation.overlay+1,";}"+( true?"":0));const Logo=/*#__PURE__*/(0,emotion_styled_base_esm/* default */.Z)(`img`, true?{target:"e8o33en0"}:0)( true?{name:"1vsgsbw",styles:"display:inline-block;height:100%;margin:0;vertical-align:middle;width:100%"}:0);const Layout=({children,image,imageTitle,imageBackgroundColor})=>(0,emotion_react_esm/* jsx */.tZ)(Container,null,image&&(0,emotion_react_esm/* jsx */.tZ)(Image,{image:image,style:{position:`fixed`},backgroundColor:imageBackgroundColor?imageBackgroundColor:false,title:imageTitle}),(0,emotion_react_esm/* jsx */.tZ)(navigation,null),(0,emotion_react_esm/* jsx */.tZ)(Main,null,children,(0,emotion_react_esm/* jsx */.tZ)("h2",null,"Documentation & related links"),(0,emotion_react_esm/* jsx */.tZ)("ul",null,(0,emotion_react_esm/* jsx */.tZ)("li",null,"See the",` `,(0,emotion_react_esm/* jsx */.tZ)("a",{href:"https://www.gatsbyjs.com/plugins/gatsby-image/?=gatsby-plugin-image"},(0,emotion_react_esm/* jsx */.tZ)("code",null,"gatsby-plugin-image")," project README"),` `," for documentation on using the plugin"),(0,emotion_react_esm/* jsx */.tZ)("li",null,"Read the docs:",(0,emotion_react_esm/* jsx */.tZ)("br",null),(0,emotion_react_esm/* jsx */.tZ)("a",{href:"https://www.gatsbyjs.com/docs/how-to/images-and-media/using-gatsby-plugin-image/"},"Using the Gatsby Image plugin"),(0,emotion_react_esm/* jsx */.tZ)("br",null),(0,emotion_react_esm/* jsx */.tZ)("a",{href:"https://www.gatsbyjs.com/docs/reference/built-in-components/gatsby-plugin-image/"},"Gatsby Image plugin reference guide")))),(0,emotion_react_esm/* jsx */.tZ)(LogoLink,{href:"https://www.gatsbyjs.com/"},(0,emotion_react_esm/* jsx */.tZ)(Logo,{src:monogram,alt:"Gatsby"})));/* harmony default export */ const layout = (Layout);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8609);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _emotion_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8592);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6657);
function _EMOTION_STRINGIFIED_CSS_ERROR__(){return"You have tried to stringify object returned from `css` function. It isn't supposed to be used directly (e.g. as value of the `className` prop), but rather handed to emotion so it can handle it (e.g. as value of `css` prop).";}var _ref= true?{name:"1i9vogi",styles:"margin-top:0"}:0;const PageTitle=({children})=>(0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__/* .jsx */ .tZ)("h2",{css:_ref},children);/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PageTitle);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8609);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9991);
/* harmony import */ var _components_image_gallery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8413);
/* harmony import */ var _components_page_title__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8317);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1455);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6657);
const DominantColor=({data,location})=>(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)(_components_layout__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,{location:location,image:(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .getImage */ .gJ)(data.coverImage.localFile),imageTitle:`“${data.coverImage.title}” by ${data.coverImage.credit} (via unsplash.com)`},(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)(_components_page_title__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null,"Dominant Color Placeholders"),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .GatsbyImage */ .HN,{image:(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .getImage */ .gJ)(data.floatingImage.localFile),alt:`“${data.floatingImage.title}” by ${data.floatingImage.credit} (via unsplash.com)`}),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)("p",null,"The default Dominant color technique uses progressive loading to make a fast, visually pleasing experience without waiting for a full-resolution image with a blank screen."),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)("h2",null,"Progressive Loading with Minimal Effort"),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)("p",null,"Dominant color creates a properly sized div with a background color generated based on your specific image. When the page loads, the div will load first for quick display while the larger image file is downloaded and displayed. This provides a nice visual effect and improves page performance while removing the need for layout shifts when the image loads."),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)("p",null,"This technique is the default behavior when querying for an image with GraphQL or using StaticImage."),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)("h2",null,"Unsplash Dominant Color Gallery"),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)(_components_image_gallery__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,{images:data.galleryImagesCropped.edges}),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__/* .jsx */ .tZ)(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .GatsbyImage */ .HN,{image:(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .getImage */ .gJ)(data.fullWidthImage.localFile),alt:`“${data.fullWidthImage.title}” by ${data.fullWidthImage.credit} (via unsplash.com)`}));/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DominantColor);const query="2062390744";
...
;
//# sourceMappingURL=component---src-pages-dominant-color-js.js.map